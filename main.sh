...
experiment_name="fig2bc"
for i in {0..10}; do python -u main_icl.py --SLURM_ARRAY_TASK_ID $SLURM_ARRAY_TASK_ID --batch-size 128 --optimizer SGD --lr 0.01 --wd 1e-10  --arch causal_transformer_embed --is_layer_norm True  --num_hidden_features 512 --is_equalize_classes False --len_context 100 --burstiness 1 --L 2 --epsilon 0.0 --fileprefix transformer1layer_lr_0.01_no_posenc --wandb_log --wandb_project l2l --experiment_name ${experiment_name} ; done 
